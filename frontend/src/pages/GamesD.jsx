            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Penalty Time Min</th>
                        <th>Penalty Time Sec</th>
                        <th>Faceoffs</th>
                        <th>Faceoffs Won</th>
                        <th>Hits</th>
                        <th>Blocked Shots</th>
                ...
                <tbody>
                    {games.map((game) => (
                        <tr key={game.id}>
                            ...
                            <td>{game.Opponent}</td>
                            <td>{game.Score_HC}</td>
                            <td>{game.Score_Opp}</td>
                            <td>{game.Goals}</td>
                            <td>{game.Penalties}</td>
                            <td>{game.PenaltiesDrawn}</td>
                            <td>{game.PenaltyTimeMin}</td>
                            <td>{game.PenaltyTimeSec}</td>
                            <td>{game.Faceoffs}</td>
                            <td>{game.FaceoffsWon}</td>
                            <td>{game.Hits}</td>
                            <td>{game.BlockedShots}</td>
                            <td>{game.Shots}</td>
                            <td>{game.ShotsOnGoal}</td>
                            <td>{game.PowerPlay}</td>
                            <td>{game.SuccessfulPowerPlay}</td>
                            <td>{game.PowerPlayPercentage}</td>
                            <td>{game.ShortHanded}</td>
                            <td>{game.PenaltyKilling}</td>
                            <td>{game.xG}</td>
                            <td>{game.OpponentXG}</td>
                            <td>{game.XGPerShot}</td>
                            <td>{game.XGConversion}</td>
                            <td>{game.ScoringChances}</td>
                            <td>
