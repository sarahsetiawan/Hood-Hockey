...
from . import views
from .views import DriveBasicQueryView, FaceoffWinPercentView, GARView, GamesFileUploadView, GamesQueryView, GoaliesQueryView, GoaliesSavePercentBarChartView, PERView, SavesPerGameView, testListCreate, testFileUpload, SkatersFileUploadView, GoaliesFileUploadView, LinesFileUploadView, DriveFileUploadView, LinesRankingsView, FitnessCorrelationView, SkaterCFView
